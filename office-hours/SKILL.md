...
1. Briefly reflect one or two specific things the user demonstrated (narrow wedge thinking, premise pushback, taste, etc.) — quote their actual words.
2. Restate the concrete assignment the design doc produced (the "next action").
3. Point to the next skill.

### Next-skill recommendations

- **`/plan-ceo-review`** for ambitious features (EXPANSION mode) — rethink the problem
